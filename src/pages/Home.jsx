...
export function Home() {
  return (
    <>
      <div id="home" className="min-h-screen w-full bg-[var(--primary)] flex flex-col items-center justify-center sm:justify-around">
        <div className="flex flex-col-reverse md:flex-row items-center justify-evenly text-white w-full gap-6">
          ...
          <div className="profile-container w-48 h-48 md:w-60 md:h-68 lg:h-70 lg:w-70 flex items-center justify-center shadow-md shadow-green-500 rounded-full text-[var(--tertiary)] p-1 relative">
            <img
              src={profile}
              alt="Profile"
              className="h-full w-full rounded-full object-cover max-w-lg max-h-lg"
            />
          </div>
        </div>
      </div>
